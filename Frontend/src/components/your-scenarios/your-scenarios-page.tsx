      ...
      <section className="relative min-h-[calc(100vh-150px)] border-b border-white/10 px-5 py-10 md:px-8">
        ...
        <div className="relative z-10 mx-auto w-full max-w-[1150px] pt-24">
          ...
          <p className="mx-auto mt-3 max-w-[780px] text-center text-sm leading-7 text-white/70">
            Community scenarios you created - edit drafts, pending scenarios, and live scenarios. Live edits go back into review before they show publicly again.
          </p>
                            ...
                            <div className="min-w-0 flex-1">
                              ...
                              story.moderationStatus === 'APPROVED' ? (
                                <p className="mt-2 text-[11px] leading-relaxed text-white/55">
                                  Edit this live scenario to send the updated version back into review.
                                </p>
                              ) : null}
