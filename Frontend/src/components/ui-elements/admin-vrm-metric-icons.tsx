/** Heart + message icons for admin VRM tables. Size is 4/3 of the former size-3.5 (14px -> ~18.67px). */
...
export function AdminVrmMetricMessagesIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className ?? metricIconSizeClass} fill="currentColor" aria-hidden>
