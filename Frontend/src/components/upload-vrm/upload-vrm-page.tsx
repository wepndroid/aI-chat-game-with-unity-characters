          ...
          <div className="mt-10 grid gap-8 lg:grid-cols-[380px_1fr]">
            ...
            <form onSubmit={handleSubmit} className="rounded-md border border-white/10 bg-[#1a1414]/95 p-6 md:p-10">
              ...
              <p className="mt-4 text-[11px] text-white/55">
                {isEditing && (formState.vroidFileUrl || formState.previewImageUrl)
                  ? 'Leave dropzones empty to keep your current VRM and preview. Choose new files to replace them.'
                  : 'Files are uploaded when you submit; public URLs are set automatically.'}
              </p>
